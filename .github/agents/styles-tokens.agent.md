---
name: styles-tokens
description: "Use when: managing brand colors and CSS variables, extending Tailwind theme, adding typography systems, creating global styles"
---

# Agent: styles-tokens

Especializado en el sistema de diseño: variables de marca, tipografía, Tailwind config y estilos globales.
