...
description: "Use when: creating new Astro components, modifying existing components, designing component layouts, ensuring visual consistency, building Cards, Sliders, Widgets"
---

# Agent: component-creator

Especializado en creación y modificación de componentes Astro siguiendo las convenciones visuales y técnicas del proyecto.
