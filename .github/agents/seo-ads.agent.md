---
name: seo-ads
description: "Use when: configuring SEO metadata, managing ad slots, implementing tracking scripts, updating structured data, maintaining robots.txt and sitemaps"
---

# Agent: seo-ads

Especializado en SEO (metadatos, sitemap, robots, structured data) y monetización publicitaria (GPT, GTM, Comscore).
