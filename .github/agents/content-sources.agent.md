...
description: "Use when: configuring WordPress API sources, modifying content fetching logic, adjusting data aggregation, adding new content feeds, handling API errors"
---

# Agent: content-sources

Especializado en la capa de agregación de contenido desde múltiples sitios WordPress REST API.
