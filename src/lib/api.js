import { wpSites, wpSiteEnfoqueNoticias, wpSitesConfig, wpSiteEnfoqueConfig, wpSiteGamecastConfig, wpSiteOyeConfig } from '../config/sites.js';

// Mapa rápido de URL → { estacion, logo } para taggear posts al hacer fetch
const siteMetaByUrl = Object.fromEntries(
    [...wpSitesConfig, wpSiteEnfoqueConfig, wpSiteGamecastConfig, ...wpSiteOyeConfig].map(s => [s.url, { estacion: s.estacion, logo: s.logo }])
)
