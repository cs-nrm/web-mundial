...
function initGPT() {
  googletag.cmd.push(function () {
    ...
    if (document.getElementById('ad-slot3'))
      window.slot3 = googletag.defineSlot('/23349147378/Mundial', [[970, 250], [320, 50]], 'ad-slot3').defineSizeMapping(mapping3).addService(googletag.pubads());

    if (document.getElementById('ad-slot32'))
      window.slot32 = googletag.defineSlot('/23349147378/Mundial', [[728, 90], [320, 50]], 'ad-slot32').defineSizeMapping(mapping32).addService(googletag.pubads());

    if (document.getElementById('ad-slot4'))
      window.slot4 = googletag.defineSlot('/23349147378/Mundial', [[728, 90], [320, 50]], 'ad-slot4').defineSizeMapping(mapping4).addService(googletag.pubads());
    ...
    if (document.getElementById('ad-slot6'))
      window.slot6 = googletag.defineSlot('/23349147378/Mundial', [[970, 90], [320, 50]], 'ad-slot6').defineSizeMapping(mapping6).addService(googletag.pubads());

    if (document.getElementById('ad-slot14'))
      window.slot14 = googletag.defineSlot('/23349147378/Mundial', [[600, 800], [320, 480]], 'ad-slot14').defineSizeMapping(mapping14).addService(googletag.pubads());

    if (document.getElementById('ad-slot-videonota'))
      window.slotVideoNota = googletag.defineSlot('/23349147378/Mundial', [400, 311], 'ad-slot-videonota').defineSizeMapping(mappingVideoNota).addService(googletag.pubads());
